...
async function startServer() {
  try {
    ...
    // curl -X POST -H "Content-Type: application/json" -d '{"message": "Build a team to make an iOS app from employees in our HR database, and tell me the talent gaps."}' http://localhost:3000/chat
